...
db.query("CREATE TABLE IF NOT EXISTS warnings (id INT(200) NOT NULL AUTO_INCREMENT, userId TEXT NOT NULL, guildId TEXT NOT NULL, reason TEXT NOT NULL, PRIMARY KEY (id))");